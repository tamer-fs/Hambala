...
class TitleWindow:
    def __init__(self, screen):
        ...
        self.play_last_saved_btn = Button((50, "%"), (30, "%"), (60, "%"), (self.btn_h_percent, "%"), "Play last saved...", self.manager, self.screen_width, self.screen_height)
        self.load_game_btn = Button((50, "%"), (40, "%"), (60, "%"), (self.btn_h_percent, "%"), "Load game...", self.manager, self.screen_width, self.screen_height)
        self.create_game_btn = Button((50, "%"), (55, "%"), (60, "%"), (self.btn_h_percent, "%"), "Create new game ...", self.manager, self.screen_width, self.screen_height)
        self.settings_btn = Button((35, "%"), (90, "%"), (30, "%"), (self.btn_h_percent, "%"), "SETTINGS", self.manager, self.screen_width, self.screen_height)
