...
class LoadSaveWindow:
    def __init__(self, screen):
        ...
        self.search_input = InputEntry((50, "%"), (28, "%"), (60, "%"), (self.btn_h_percent, "%"), "Find save...", self.manager, self.screen_width, self.screen_height)
        self.load_game_btn = Button((50, "%"), (72, "%"), (60, "%"), (self.btn_h_percent, "%"), "Load Game", self.manager, self.screen_width, self.screen_height)
        ...
        for game_dir in self.game_dirs:
            with open(os.path.join("saves", game_dir, "save.json"), "r") as f:
        ...
        self.games_list_el = pygame_gui.elements.UISelectionList(manager=self.manager, relative_rect=pygame.Rect(window_free_space, self.screen_height/3, games_list_width, self.screen_height/3), item_list=self.game_names)
        ...
        for event in events:
            ...
            if event.type == pygame_gui.UI_BUTTON_PRESSED:
                if event.ui_element == self.back_btn.button:
                    ...
                    selected_world = self.game_names_to_dirs[self.games_list_el.get_single_selection()]
